    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST,   "/api/salons/**", "/api/salon/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT,    "/api/salons/**", "/api/salon/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/salons/**", "/api/salon/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST,   "/api/service-offerings/**", "/api/service-offering/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT,    "/api/service-offerings/**", "/api/service-offering/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/service-offerings/**", "/api/service-offering/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST,   "/api/categories/**", "/api/category/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT,    "/api/categories/**", "/api/category/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/categories/**", "/api/category/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST,   "/api/stylists/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT,    "/api/stylists/**").hasAnyRole("ADMIN", "STYLIST")
                .requestMatchers(HttpMethod.DELETE, "/api/stylists/**").hasRole("ADMIN")
